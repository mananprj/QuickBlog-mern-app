    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/5 '>
        <div className='flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500'>
            <div>
                ...
                <p className='max-w-[410px] mt-6 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda quia dolorum, tempora tempore pariatur cumque consequatur minima dicta similique culpa vero blanditiis?</p>
            </div>
