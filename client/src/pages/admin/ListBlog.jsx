...
const ListBlog = () => {
  ...
  return (
    <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/20'>
        <h1 className='text-gray-800 font-semibold text-lg'>All Blogs</h1>
         ...
         <div className='relative mt-4 h-4/5 max-w-4xl overflow-x-auto shadow rounded-lg scrollbar-hide bg-white'>
                <table className='w-full text-sm text-gray-500'>
                    ...
                    <tbody>
                        {blogs.map((blog, index) => {return <BlogTableItem key={blog._id} blog={blog} fetchblog={fetchBlogs} index={index + 1}/>}) }
                    </tbody>
                </table>
            </div>
